...
Files: macbook-16.glb [639.28KB] > C:\Users\nasse\Desktop\code\macbook_app\macbookAppGui\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export function MacBookModel16(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/macbook-16-transformed.glb') as unknown as GLTFResult
